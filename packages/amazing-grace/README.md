...
The mod also mounts a compact status panel showing the ladder rung and bench
state on surfaces that support panels. The active model remains in the host's
built-in statusline.

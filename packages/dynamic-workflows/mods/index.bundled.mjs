...
var TEMPLATE_DIR = path2.resolve(import.meta.dirname, "../assets/templates");
function dynamicWorkflowsMod(ctx) {
...
export {
  dynamicWorkflowsMod as default
};
